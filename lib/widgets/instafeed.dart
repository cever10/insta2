...
class _instaFeedState extends State<instaFeed> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.img != null &&
        ...
        widget.checkimage != null &&
        widget.id != null &&
        widget.name != null &&
        widget.contents != null &&
        widget.favorite != null &&
        widget.feednumber != null &&
        widget.checkFavoriteUser != null &&
        widget.comments != null &&
        widget.checkFollow != null &&
        widget.year != null &&
        widget.month != null &&
        widget.day != null &&
        widget.hour != null &&
              ...
              children: [
                ...
                if (widget.year == DateTime.now().year.toString() &&
                  ...
                  Container(
                    padding: EdgeInsets.all(5),
                    child: Text(
                      (DateTime.now().hour - int.parse(widget.hour))
                              .toString() +
                          '시간 전',
                      style: TextStyle(
                        fontSize: 10,
                  ...
                  Container(
                    padding: EdgeInsets.all(5),
                    child: Text(
                      (DateTime.now().year - int.parse(widget.year))
                              .toString() +
                          '년 전',
                      style: TextStyle(
                        fontSize: 10,
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          onSubmitted: (value) async {
                            LocalStorage feedCommentDB = LocalStorage(
                                widget.id +
                                    '/feed' +
                                    widget.feednumber +
                                    '/comments.txt');
