...
class followingList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> fallowList = List<String>.empty(growable: true);
    ...
    Future<bool> favoriteList() async {
      LocalStorage followUserDB =
          LocalStorage(provar.current_profile_user + '/follow.txt');
      fallowList = await followUserDB.readFileToList();

      for (int i = 0; i < fallowList.length; i++) {
        UserDataList.add(await load_Memberdata(fallowList[i]));
      }
